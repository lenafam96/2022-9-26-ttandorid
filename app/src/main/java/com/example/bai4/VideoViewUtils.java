...
public class VideoViewUtils {
    ...
    public static final String RAW_VIDEO_SAMPLE = "madara";
    public static final String LOCAL_VIDEO_SAMPLE ="minato.mp4";
    ...
    public static void playLocalVideo(Context context, VideoView videoView, String localPath)  {
        try {
            Uri uri = Uri.parse("content://com.android.externalstorage.documents/document/primary%3A" + localPath);
            Log.i(LOG_TAG, "Video URI: "+ uri);
